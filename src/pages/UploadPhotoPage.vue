...
} from "~/composables/upload-photo/index.types.ts";
          ...
          <div class="download__inner">
            ...
            <div class="image-wrapper">
              <div class="download__img">
                <img src="/img/download-image-couple.jpg" alt=""
                     class="download__image"/>
              </div>
              <div class="woman">
                <div class="woman-img">
                  <img src="/img/download-image-woman.jpg" alt=""
                       class="download__image-woman"/>
                </div>
              </div>
              <div class="arrow">
            ...
            <button class="button button-upload-photo" @click="openModal">
              Загрузить фото
            </button>
          </div>
        </div>
    ...
    <div class="modal__window">
      ...
      <div class="modal__body">
        ...
        <div class="modal__body-text">
          ...
          <form id="upload-form">
            <div class="button-upload-btn upload-btn"
                 @click.prevent="inputEl?.click()">Загрузить
            </div>
            <input
                ref="inputEl"
                type="file"
